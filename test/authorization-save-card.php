...
try {
    ...
    $data = array(
	    	...
	    	"number" => "5205125564088653", // REQUIRED - Full credit card number //
	    	"expMonth" => "07", // REQUIRED - Credit card expiration month //
	    	"expYear" => "2020", // REQUIRED - Credit card expiration year //
	    	"cvvNumber" => "923", // RECOMMENDED - Credit card verification code //
	        ...
	        "customerId" => "44692974", // REQUIRED for this command - Customer ID replied by maxiPago! after the "add-customer" command //

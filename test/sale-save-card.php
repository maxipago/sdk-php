...
try {
    ...
    $data = array(
    		...
    		"shippingPhoneNumber" => "55554444",
    		"shippingPhoneExtension" => "123",
    		"shippingDocumentType" => "CPF",
    		"shippingDocumentValue" => "25922837060",
    		"number" => "5593446311877390", // REQUIRED - Full credit card number //
    		"expMonth" => "07", // REQUIRED - Credit card expiration month //
    		"expYear" => "2020", // REQUIRED - Credit card expiration year //
    		"cvvNumber" => "895", // RECOMMENDED - Credit card verification code //
    		"chargeTotal" => "160.00", // REQUIRED - Transaction amount in US format //
    		"shippingTotal" => "10.00",
    		...
    		"customerId" => "44695510", // REQUIRED for this command - Customer ID replied by maxiPago! after the "add-customer" command //
    );

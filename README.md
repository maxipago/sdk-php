...
This **PHP** library allows for easy integration with the **maxiPago! Smart Payments** platform. In order to send requests you will need valid credentials, which can be obtained from our Customer Support team at support [@] maxipago [.] com.

...
$data = array(
  ...
  "authentication" => "", // Optional - Valid only for Cielo. Please see full documentation for info //
  ...
  "customerId" => "323", // REQUIRED for this command - Customer ID replied by maxiPago! after the "add-customer" command //
